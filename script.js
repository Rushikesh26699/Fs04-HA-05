function Homepage(){
    return <div style = {{border : "1px solid black",width : "700px",height : "290px" ,backgroundColor : "white",marginLeft : "25%",marginTop : "10%",boxShadow : "0 0 20px black"}}>
        <div style = {{border : "2px solid red",color : "white",marginTop : "20px",height : "60px",backgroundColor : "#cc0000",fontFamily: "sans-serif"}}>
            <h2 style = {{width : "250px",display : "flex",justifyContent : "center",alignItems : "center"}}>Koding Made Simple</h2>
            <div style = {{fontSize : "400",fontWeight : "600",width : "300px",marginTop : "-58px",marginLeft : "350px",display : "flex",justifyContent : "space-between",flexDirection : "row",alignItems  :"center"}}>
        ...
        <div style = {{border : "none",width : "700px",height :"150px",display : "flex",justifyContent : "center",alignItems : "center",flexDirection : "column",backgroundColor : "#eeeeee",marginTop : "30px"}}>
            <h1 style = {{margin : "0px",marginLeft : "-100px",padding : "0px",fontFamily: "sans-serif"}}>Customize Bootstrap Navbar</h1>
